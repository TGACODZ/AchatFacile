        ...
        <div class="flex min-h-screen">
            <aside class="w-64 shrink-0 bg-white dark:bg-[#161615] border-r border-[#e3e3e0] dark:border-[#3E3E3A] p-6">
                ...
                <nav class="space-y-2" id="sidebar-nav">
                    <button type="button" data-target="section-dashboard" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]" aria-current="page">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>
                        <span>Dashboard</span>
                    </button>
                    <button type="button" data-target="section-compte-client" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 12c2.761 0 5-2.239 5-5s-2.239-5-5-5-5 2.239-5 5 2.239 5 5 5zm0 2c-4.418 0-8 2.239-8 5v3h16v-3c0-2.761-3.582-5-8-5z"/></svg>
                    ...
                    <button type="button" data-target="section-groupe-prix" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 2.18L19 6v5c0 4.51-3.09 8.87-7 9.93-3.91-1.06-7-5.42-7-9.93V6l7-2.82zM11 7h2v6h-2V7zm0 8h2v2h-2v-2z"/></svg>
                    ...
                    <button type="button" data-target="section-remboursement" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5V1L7 6l5 5V7c3.309 0 6 2.691 6 6a6 6 0 11-6-6z"/></svg>
                    ...
                    <button type="button" data-target="section-mes-ventes" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 3h2l3.6 7.59-1.35 2.44A2.992 2.992 0 009 17h9v-2H9.42a1 1 0 01-.9-.55L9 13h7a1 1 0 00.92-.62l3-7A1 1 0 0019 4H6.21l-.94-2H1v2h2zM9 19a2 2 0 100 4 2 2 0 000-4zm8 0a2 2 0 100 4 2 2 0 000-4z"/></svg>
                    ...
                    <button type="button" data-target="section-messages" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M20 2H4a2 2 0 00-2 2v18l4-4h14a2 2 0 002-2V4a2 2 0 00-2-2z"/></svg>
                        <span>Messages</span>
                    </button>
                    <button type="button" data-target="section-promotion" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 17l-5 3 1.9-5.9L4 9h6L12 3l2 6h6l-4.9 5.1L17 20z"/></svg>
                        <span>Promotion</span>
                    </button>
                    <button type="button" data-target="section-conseillers" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5s-3 1.34-3 3 1.34 3 3 3zM8 11c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V21h7v-2H3.5C4.46 18.76 6.97 18 8 18s3.54.76 4.5 1H9v2h7v-2.5C16 14.17 10.33 13 8 13zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V21h7v-1.5C24 14.17 18.33 13 16 13z"/></svg>
                    ...
                    <button type="button" data-target="section-stock" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M20 6H4V4h16v2zM4 8h16v10a2 2 0 01-2 2H6a2 2 0 01-2-2V8zm4 2v8h8v-8H8z"/></svg>
                        <span>Stock</span>
                    </button>
                    <button type="button" data-target="section-prospection" class="w-full text-left px-3 py-2 rounded-sm flex items-center gap-2 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-[#1C1C1A]">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>
            ...
            <main class="flex-1 p-6 lg:p-10">
                ...
                <section id="section-dashboard" data-section class="mb-8">
                    <h2 class="text-xl font-medium mb-3">Vue d'ensemble</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                        <div class="p-4 bg-white dark:bg-[#161615] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm">KPI 1</div>
                        <div class="p-4 bg-white dark:bg-[#161615] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm">KPI 2</div>
                        <div class="p-4 bg-white dark:bg-[#161615] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm">KPI 3</div>
                        <div class="p-4 bg-white dark:bg-[#161615] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm">KPI 4</div>
                    </div>
                </section>
